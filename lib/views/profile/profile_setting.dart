  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0.00,
        title: const Text("Profile Setting", style: TextStyle(color: Colors.black, fontFamily: "Montserrat", fontSize: 22, fontWeight: FontWeight.bold)),
        centerTitle: true,
        leading: IconButton(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(padding: EdgeInsets.only(bottom: 20), child: Text("Name", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat"))),
                    TextField(
                      controller: textarea,
                    ...
                    const Padding(padding: EdgeInsets.only(bottom: 20), child: Text("Link", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat"))),
                    TextField(
                      controller: textarea,
                      keyboardType: TextInputType.multiline,
                      maxLines: 1,
